...
const FormToggle = () => {
  ...
  return (
    ...
    >
      ...
      {/* Toggle Panels */}
      <div
        className={`absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-all duration-700 ease-in-out bg-gradient-to-r from-indigo-600 to-purple-800 text-white rounded-l-[150px] z-20 ${
        ...
        <div className="relative flex h-full items-center justify-center text-center">
          ...
          >
            <div>
              ...
              <button
                className="hidden px-8 py-2 text-xs font-bold text-white bg-transparent border border-white rounded uppercase "
